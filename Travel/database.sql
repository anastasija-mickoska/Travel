...
(1, 'Istanbul', '2025-04-26', '2025-04-29', 'İstanbul welcomes the spring in style with Judas trees that bloom along the Bosphorus coastline, tulips that surround the entire city and create mesmerizing views in Emirgan Forest and Göztepe Park, which host the Tulip Festival.', 180.00, 'Istanbul', 'https://img.freepik.com/premium-photo/spring-istanbul-turkey_928112-1833.jpg', NOW()),
...
('dolores@gmail.com', '650215acec746f0e32bdfff387439eefc1358737', 'Dolores', 'Medina'),
('liam_s@gmail.com', '3f563468d42a448cb1e56924529f6e7bbe529cc7', 'Liam', 'Stephens'),
('theodore_adams@yahoo.com', 'ed19f5c0833094026a2f1e9e6f08a35d26037066', 'Theodore', 'Adams'),
('kaya@outlook.com', 'db13f3c1833094006a2f1e9e6f05a35d06137846', 'Kaya', 'Miller');

INSERT INTO admins ( emailAddress, password, FullName) VALUES
( 'admin1@travelagency.com', '6a718fbd768c2378b511f8249b54897f940e9022', 'Admin1'),
( 'admin2@travelagency.com', '971e95957d3b74d70d79c20c94e9cd91b85f7aae', 'Admin2');
