                ...
                <form method="get">
                    <div class="Forms">
                        ...
                        <select class="form1" for="priceRange">
                            <option for="priceRange" value=""></option>
                            <option for="priceRange" value="0-100">0-100</option>
                            <option for="priceRange" value="101-200">101-200</option>
                            <option for="priceRange" value="201-300">201-300</option>
                            <option for="priceRange" value="301-400">301-400</option>
                            <option for="priceRange" value="401-500">401-500</option>
                            <option for="priceRange" value="500+">500+</option>
                        </select>
                    </div>
                    <div class="Forms">
